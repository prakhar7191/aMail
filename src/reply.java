...
public class reply extends HttpServlet{
	...
	throws IOException,ServletException{
		...
		try{
			...
			e.printStackTrace();
			pout.print("some error occurred. Please try again.");
		}
